...
import com.reloaded.sales.util.PrintVariant;
...
public class PdfService {
  ...
  public byte[] generateInvoicePdf(OrderForm orderForm) throws IOException {
    ...
    List<PrintVariant> variants = List.of(new PrintVariant("ОРИГИНАЛ", "bg"), new PrintVariant("", "bg"));
